...
| Native app catalog | Три static descriptor связывают logical card с Prompt, Cue и Vector ID; catalog содержит только data, а selection никогда не запускает application |
