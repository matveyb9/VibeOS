...
| Начальная key policy | Pressed Tab выбирает next focus, Shift+Tab выбирает previous focus, pressed Enter выбирает focused logical window; release и unmapped key игнорируются |
