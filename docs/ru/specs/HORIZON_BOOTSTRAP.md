...
| Начальная key policy | Pressed Tab выбирает next focus, pressed Enter выбирает focused logical window; release и unmapped key игнорируются |
