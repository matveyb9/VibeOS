...
| Native app catalog | Three static descriptors bind logical cards to Prompt, Cue, and Vector IDs; the catalog is data-only and selection never launches an application |
