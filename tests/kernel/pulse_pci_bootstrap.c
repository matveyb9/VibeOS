...
static uint32_t fake_read(void *context, uint8_t bus, uint8_t device, uint8_t function, uint8_t offset) {
    (void)context;
    if (bus == 1U && device == 0U && function == 0U && offset == 0U) return UINT32_C(0x29228086);
    if (bus == 1U && device == 0U && function == 0U && offset == 8U) return UINT32_C(0x01060100);
    if (bus == 1U && device == 0U && function == 0U && offset == 12U) return UINT32_C(0x00000000);
    ...
    if (device == 2U && function == 0U && offset == 12U) return UINT32_C(0x00810000);
    if (device == 2U && function == 0U && offset == 24U) return UINT32_C(0x00010100);
